...
> **Common lumps** (read by ≥50% of actors, omitted per-row): joint-channel, light-index, name, nav-max-users, nav-mesh-actor, options, shadow-mask, texture-bucket, trans, trans-offset
...
| `ram` | Ram | **alt-actor**, extra-id, mode |
...
| `plat-eco` | Eco Platform | notice-dist · _DB-only: flags, sync_ |
